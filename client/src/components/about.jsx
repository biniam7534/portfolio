            ...
            <div className='max-w-6xl mx-auto'>
                ...
                <div className='text-center mb-16'>
                    <h2 className='text-4xl md:text-5xl font-black mb-4'>
                        About <span className='bg-gradient-to-r from-accent to-amber-500 bg-clip-text text-transparent'>Me</span>
                    </h2>
                ...
                <div className='flex flex-col lg:flex-row items-center gap-12 lg:gap-20'>
                    ...
                    <div className='lg:w-1/2 relative group'>
                        <div className='absolute -inset-2 bg-gradient-to-r from-accent to-amber-500 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200'></div>
                    ...
                    <div className='lg:w-1/2'>
                        ...
                        <div className='grid grid-cols-1 ssm:grid-cols-2 gap-6 mb-8'>
                            <div className='p-4 rounded-xl bg-secondary/50 border border-accent/10 hover:border-accent/30 transition-all'>
